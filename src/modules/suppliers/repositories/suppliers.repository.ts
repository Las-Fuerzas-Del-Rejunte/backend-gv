...
import {
  SuppliersSupabaseAdapter,
  SupplierRecord,
} from './suppliers.supabase-adapter';

@Injectable()
export class SuppliersRepository extends SupabaseCrudRepository<
  SupplierRecord,
  Supplier,
  CreateSupplierDto,
  UpdateSupplierDto
> {
  ...
  constructor(supabase: SupabaseService, adapter: SuppliersSupabaseAdapter) {
    super(supabase);
